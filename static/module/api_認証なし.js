...
function POSTmap_delete(url, id, map_id) {
    return new Promise((resolve, reject) => {
        axios
            .post(url + id + "/maps/" + map_id + "/delete")
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function GETget_map(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/get_map?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTget_map(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/get_map", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETsave_map(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/save_map?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTsave_map(url, id, map_name) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/save_map", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETcreate_map(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/create_map?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTcreate_map(url, id, command) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/create_map", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETdeploy_map(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/deploy_map?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTdeploy_map(url, id, map_id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/deploy_map", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETget_map_id(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/get_map_id?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTget_map_id(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/get_map_id", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETinitialize_pose(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/initialize_pose?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTinitialize_pose(url, id, x, y, angle) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/initialize_pose", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETget_pose(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/get_pose?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTget_pose(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/get_pose", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETstop(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/idle?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function GETfollow(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/follow?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTfollow(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/follow", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETroute_navigation(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(
                url + id + "/service/route_navigation?service_id=" + service_id
            )
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
...
function POSTroute_navigation(url, id, route_position, angle) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/route_navigation", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
    ...
    return new Promise((resolve, reject) => {
        axios
            .get(
                url +
                    id +
                    "/service/route_navigation/pause?service_id=" +
                    service_id
            )
            .then((response) => {
                if (response.status === 200) {
...
function POSTroute_navigation_pause(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/route_navigation/pause", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
    ...
    return new Promise((resolve, reject) => {
        axios
            .get(
                url +
                    id +
                    "/service/route_navigation/resume?service_id=" +
                    service_id
            )
            .then((response) => {
                if (response.status === 200) {
...
function POSTroute_navigation_resume(url, id, route_navigation_service_id) {
    return new Promise((resolve, reject) => {
        const data = new FormData();
        data.append("route_navigation_service_id", route_navigation_service_id);
        data.append("timeout", timeout);
...
function GETnavigate(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/navigation?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTnavigate(url, id, x, y, angle) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/navigation", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETnavigate_pause(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(
                url + id + "/service/navigation/pause?service_id=" + service_id
            )
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
...
function POSTnavigate_pause(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/navigation/pause", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETnavigate_resume(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(
                url + id + "/service/navigation/resume?service_id=" + service_id
            )
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
...
function POSTnavigate_resume(url, id, navigation_service_id) {
    return new Promise((resolve, reject) => {
        const data = new FormData();
        data.append("navigation_service_id", navigation_service_id);
        data.append("timeout", timeout);
...
function GETleading_navigate(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/lead_navigation?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTleading_navigate(url, id, x, y, angle) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/lead_navigation", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETget_image(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/get_image?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTget_image(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/get_image", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function POSTstreaming(url, id, command) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/camera/streaming", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function GETget_gnss_position(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(
                url + id + "/service/get_gnss_position?service_id=" + service_id
            )
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
...
function POSTget_gnss_position(url, id) {
    return new Promise((resolve, reject) => {
        ...
        data.append("timeout", timeout);
        axios
            .post(url + id + "/service/get_gnss_position", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETmic_recognition(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/mic_recognition?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTmic_recognition(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/mic_recognition", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
    ...
    return new Promise((resolve, reject) => {
        axios
            .get(
                url +
                    id +
                    "/service/speech_recognition_google?service_id=" +
                    service_id
            )
            .then((response) => {
                if (response.status === 200) {
...
function POSTspeech_recognition_google(url, id, language) {
    ...
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/speech_recognition_google", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETspeak(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/speak?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTspeak(url, id, speak_text, voice_name) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/speak", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function POSTmedia_delete(url, id, media_id) {
    return new Promise((resolve, reject) => {
        axios
            .post(url + id + "/media/" + media_id + "/delete")
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function GETplay_media(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/play_media?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTplay_media(url, id, media_id, loop) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/play_media", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function POSTstop_media(url, id) {
    return new Promise((resolve, reject) => {
        axios
            .post(url + id + "/service/stop_media")
            .then((response) => {
                if (response.status === 200) {
                    resolve();
                } else {
...
function POSTfaces_delete(url, id, face_id) {
    return new Promise((resolve, reject) => {
        axios
            .post(url + id + "/faces/" + face_id + "/delete")
            .then((response) => {
                if (response.status === 200) {
                    resolve();
                } else {
...
function GETface_recognition(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(
                url + id + "/service/face_recognition?service_id=" + service_id
            )
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
...
function POSTface_recognition(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/face_recognition", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function POSTobject_models(url, id, formData) {
    return new Promise((resolve, reject) => {
        axios
            .post(url + id + "/object_models", formData)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function GETobject_detection(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(
                url + id + "/service/object_detection?service_id=" + service_id
            )
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
...
function POSTobject_detection(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/object_detection", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETpeople_count(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/people_count?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTpeople_count(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/people_count", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETpeople_profile(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/people_profile?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTpeople_profile(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/people_profile", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETgathering(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/gathering?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTgathering(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/gathering", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETread_qr(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/read_qr?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTread_qr(url, id, duration) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/read_qr", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
...
function GETio(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/io?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function GETstop_all(url, id, service_id) {
    return new Promise((resolve, reject) => {
        axios
            .get(url + id + "/service/stop_all?service_id=" + service_id)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data);
                } else {
...
function POSTstop_all(url, id) {
    return new Promise((resolve, reject) => {
        ...
        axios
            .post(url + id + "/service/stop_all", data)
            .then((response) => {
                if (response.status === 200) {
                    resolve(response.data.service_id);
                } else {
